...
## 🛠️ Tech & Tools
Primary languages, frameworks, and tools I use day-to-day (grouped by role as a web developer):
...
### Backend
- Languages & Frameworks: Node.js, Express, Python (Flask / FastAPI)
- APIs & Communication: REST, GraphQL, gRPC
...
![gRPC](https://img.shields.io/badge/-gRPC-00A1F1?style=for-the-badge&logo=grpc&logoColor=white)

### Databases & Storage
- PostgreSQL, Redis, MongoDB (when needed)

![PostgreSQL](https://img.shields.io/badge/-PostgreSQL-336791?style=for-the-badge&logo=postgresql&logoColor=white)
![Redis](https://img.shields.io/badge/-Redis-DC382D?style=for-the-badge&logo=redis&logoColor=white)

### Cloud, DevOps & Infra
- Cloud & IaaC: AWS (EC2, S3, RDS), Terraform
...
- Go (for tooling & backend services), Python
- Git, GitHub, Postman
...
## 📫 How you can help me
- Star my projects, file issues with improvements, or send PRs
- Connect on LinkedIn or drop a message if you'd like to collaborate
